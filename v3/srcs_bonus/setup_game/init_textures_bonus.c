...
/*   Updated: 2023/08/07 23:15:49 by hmaciel-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures(t_root *game, t_file *file)
{
	...
	game->menu.menu_back.img = mlx_xpm_file_to_image(game->mlx, "./assets/menu_back.xpm", &game->menu.menu_back.w, &game->menu.menu_back.h);
	game->menu.button_h.img = mlx_xpm_file_to_image(game->mlx, "./assets/play_h.xpm", &game->menu.button_h.w, &game->menu.button_h.h);
	game->menu.button_n.img = mlx_xpm_file_to_image(game->mlx, "./assets/play_n.xpm", &game->menu.button_n.w, &game->menu.button_n.h);
	game->menu.button_q.img = mlx_xpm_file_to_image(game->mlx, "./assets/quit.xpm", &game->menu.button_q.w, &game->menu.button_q.h);
	game->menu.menu_back.addr = mlx_get_data_addr(game->menu.menu_back.img, &game->menu.menu_back.bits_per_pixel, &game->menu.menu_back.line_length, &game->menu.menu_back.endian);
	game->menu.button_h.addr = mlx_get_data_addr(game->menu.button_h.img, &game->menu.button_h.bits_per_pixel, &game->menu.button_h.line_length, &game->menu.button_h.endian);
	game->menu.button_n.addr = mlx_get_data_addr(game->menu.button_n.img, &game->menu.button_n.bits_per_pixel, &game->menu.button_n.line_length, &game->menu.button_n.endian);
	game->menu.button_q.addr = mlx_get_data_addr(game->menu.button_q.img, &game->menu.button_q.bits_per_pixel, &game->menu.button_q.line_length, &game->menu.button_q.endian);
}
